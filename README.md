...
API Documentation
-----------------
The doxygen generated documentation for public APIs currently supported by the Open Enclave SDK can be found [here](https://openenclave.github.io/openenclave/api/index.html).
