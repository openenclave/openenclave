...
commands 5
    ...
    # oe_debug_enclave_t
    python gdb.parse_and_eval("ENCLAVE_OFFSETOF_MAGIC = " + str(oe_debug_enclave_t.OFFSETOF_MAGIC))
    python gdb.parse_and_eval("ENCLAVE_SIZEOF_MAGIC = " + str(oe_debug_enclave_t.SIZEOF_MAGIC))
    python gdb.parse_and_eval("ENCLAVE_MAGIC_VALUE = " + str(oe_debug_enclave_t.MAGIC_VALUE))

    python gdb.parse_and_eval("ENCLAVE_OFFSETOF_VERSION = " + str(oe_debug_enclave_t.OFFSETOF_VERSION))
    python gdb.parse_and_eval("ENCLAVE_SIZEOF_VERSION = " + str(oe_debug_enclave_t.SIZEOF_VERSION))

    python gdb.parse_and_eval("ENCLAVE_OFFSETOF_NEXT = " + str(oe_debug_enclave_t.OFFSETOF_NEXT))
    python gdb.parse_and_eval("ENCLAVE_SIZEOF_NEXT = " + str(oe_debug_enclave_t.SIZEOF_NEXT))

    python gdb.parse_and_eval("ENCLAVE_OFFSETOF_PATH = " + str(oe_debug_enclave_t.OFFSETOF_PATH))
    python gdb.parse_and_eval("ENCLAVE_SIZEOF_PATH = " + str(oe_debug_enclave_t.SIZEOF_PATH))
    ...
    python gdb.parse_and_eval("ENCLAVE_OFFSETOF_TCS_ARRAY = " + str(oe_debug_enclave_t.OFFSETOF_TCS_ARRAY))
    python gdb.parse_and_eval("ENCLAVE_SIZEOF_TCS_ARRAY = " + str(oe_debug_enclave_t.SIZEOF_TCS_ARRAY))

    python gdb.parse_and_eval("ENCLAVE_OFFSETOF_TCS_COUNT = " + str(oe_debug_enclave_t.OFFSETOF_TCS_COUNT))
    python gdb.parse_and_eval("ENCLAVE_SIZEOF_TCS_COUNT = " + str(oe_debug_enclave_t.SIZEOF_TCS_COUNT))

    python gdb.parse_and_eval("ENCLAVE_OFFSETOF_FLAGS = " + str(oe_debug_enclave_t.OFFSETOF_FLAGS))
    python gdb.parse_and_eval("ENCLAVE_SIZEOF_FLAGS = " + str(oe_debug_enclave_t.SIZEOF_FLAGS))
    python gdb.parse_and_eval("ENCLAVE_MASK_DEBUG = " + str(oe_debug_enclave_t.MASK_DEBUG))
    python gdb.parse_and_eval("ENCLAVE_MASK_SIMULATE = " + str(oe_debug_enclave_t.MASK_SIMULATE))

    python gdb.parse_and_eval("ENCLAVE_OFFSETOF_MODULES = " + str(oe_debug_enclave_t.OFFSETOF_MODULES))
    python gdb.parse_and_eval("ENCLAVE_SIZEOF_MODULES = " + str(oe_debug_enclave_t.SIZEOF_MODULES))


    # oe_debug_module_t
    python gdb.parse_and_eval("MODULE_OFFSETOF_MAGIC = " + str(oe_debug_module_t.OFFSETOF_MAGIC))
    python gdb.parse_and_eval("MODULE_SIZEOF_MAGIC = " + str(oe_debug_module_t.SIZEOF_MAGIC))
    python gdb.parse_and_eval("MODULE_MAGIC_VALUE = " + str(oe_debug_module_t.MAGIC_VALUE))

    python gdb.parse_and_eval("MODULE_OFFSETOF_VERSION = " + str(oe_debug_module_t.OFFSETOF_VERSION))
    python gdb.parse_and_eval("MODULE_SIZEOF_VERSION = " + str(oe_debug_module_t.SIZEOF_VERSION))

    python gdb.parse_and_eval("MODULE_OFFSETOF_NEXT = " + str(oe_debug_module_t.OFFSETOF_NEXT))
    python gdb.parse_and_eval("MODULE_SIZEOF_NEXT = " + str(oe_debug_module_t.SIZEOF_NEXT))

    python gdb.parse_and_eval("MODULE_OFFSETOF_PATH = " + str(oe_debug_module_t.OFFSETOF_PATH))
    python gdb.parse_and_eval("MODULE_SIZEOF_PATH = " + str(oe_debug_module_t.SIZEOF_PATH))
