...
static void _test_sgx_remote()
{
    ...
    verify_sgx_evidence(
        ...
        NULL,
        0,
        endorsements, // reuse the endorsement generated above
        endorsements_size,
        test_claims,
        TEST_CLAIMS_SIZE);
    ...
    printf("testing a 65-byte custom claims that should failed\n");
    OE_TEST_CODE(
        oe_get_evidence(
            &_ecdsa_report_uuid,
            0,
    ...
    verify_sgx_evidence(
        &_ecdsa_quote_uuid,
        false,
        // offset OE_report by oe_report_header_t to get OE_report.report which
        // is an SGX quote
