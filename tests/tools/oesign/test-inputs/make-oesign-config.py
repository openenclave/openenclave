...
if __name__ == "__main__":
    ...
    arg_parser.add_argument('--ext_product_id', default=None, type=str, help="Value for the IsvExtProductID property. Defaults to empty string")
    arg_parser.add_argument('--family_id', default=None, type=str, help="Value for the IsvFamilyID property. Defaults to empty string.")
    ...
    if args.ext_product_id != None:
        out_file.write("IsvExtProductID={}\n".format(args.ext_product_id))
    if args.family_id != None:
