...
int TestAllTypes(bool trace)
{
    ...
    // Test oe_clear_arg():
    {
        ...
        TEST(z.str == NULL);
        TEST(!oe_clear_arg_by_name(sti, &y, "wcs", 1, &z.wcs, free));
        TEST(z.wcs == NULL);
        TEST(!oe_clear_arg_by_name(sti, &y, "wcsa", 0, z.wcsa, free));
        ...
        TEST(!oe_clear_arg_by_name(sti, &y, "w", 0, &z.w, free));
    ...
    // Test oe_set_arg():
    {
        ...
        TEST(!oe_set_arg_by_name(sti, &y, "w", 0, &z.w, malloc));
        ...
        TEST(!oe_set_arg_by_name(sti, &y, "wcs", 1, &z.wcs, malloc));
        TEST(!oe_set_arg_by_name(sti, &y, "stra", 0, z.stra, malloc));
        TEST(!oe_set_arg_by_name(sti, &y, "wcsa", 0, z.wcsa, malloc));
