...
void TestNegative(oe_issue_date_t dateTime, oe_result_t result)
{
    char utcString[21];
    size_t length = sizeof(utcString);
    OE_TEST(oe_issue_date_to_string(&dateTime, utcString, &length) == result);
}
...
OE_ECALL void TestIso861Time(void*)
{
    ...
    TestPositive(
        oe_issue_date_t{2018, 12, 18, 0, 0, 0}, "2018-12-18T00:00:00Z");

    // Single digit hours
    TestPositive(
        oe_issue_date_t{2018, 12, 18, 1, 0, 0}, "2018-12-18T01:00:00Z");

    // And single digit minutes
    TestPositive(
        oe_issue_date_t{2018, 12, 18, 1, 1, 0}, "2018-12-18T01:01:00Z");

    // And single digit seconds
    TestPositive(
        oe_issue_date_t{2018, 12, 18, 1, 1, 1}, "2018-12-18T01:01:01Z");

    // Double digit seconds
    TestPositive(
        oe_issue_date_t{2018, 12, 18, 1, 1, 11}, "2018-12-18T01:01:11Z");

    // And double digit minutes
    TestPositive(
        oe_issue_date_t{2018, 12, 18, 1, 13, 11}, "2018-12-18T01:13:11Z");
    ...
    TestPositive(
        oe_issue_date_t{2018, 11, 30, 0, 0, 0}, "2018-11-30T00:00:00Z");
    TestPositive(
...
OE_ECALL void TestIso861TimeNegative(void*)
{
    ...
    TestNegative(
        oe_issue_date_t{1969, 8, 8, 0, 0, 0}, OE_INVALID_UTC_DATE_TIME);

    // Zero and 13 months
    TestNegative(
        oe_issue_date_t{2018, 0, 8, 0, 0, 0}, OE_INVALID_UTC_DATE_TIME);
    TestNegative(
        oe_issue_date_t{2018, 0, 13, 0, 0, 0}, OE_INVALID_UTC_DATE_TIME);

    // Invalid hour, minutes, seconds.
    TestNegative(
        oe_issue_date_t{2018, 8, 8, 24, 0, 0}, OE_INVALID_UTC_DATE_TIME);
    TestNegative(
        oe_issue_date_t{2018, 8, 8, 0, 60, 0}, OE_INVALID_UTC_DATE_TIME);
    TestNegative(
        oe_issue_date_t{2018, 8, 8, 0, 0, 60}, OE_INVALID_UTC_DATE_TIME);

    // Invalid days for all months except February.
    TestNegative(
        oe_issue_date_t{2018, 1, 32, 0, 0, 0}, OE_INVALID_UTC_DATE_TIME);
    TestNegative(
        oe_issue_date_t{2018, 3, 32, 0, 0, 0}, OE_INVALID_UTC_DATE_TIME);
    TestNegative(
        oe_issue_date_t{2018, 4, 31, 0, 0, 0}, OE_INVALID_UTC_DATE_TIME);
    TestNegative(
        oe_issue_date_t{2018, 5, 32, 0, 0, 0}, OE_INVALID_UTC_DATE_TIME);
    TestNegative(
        oe_issue_date_t{2018, 6, 31, 0, 0, 0}, OE_INVALID_UTC_DATE_TIME);
    TestNegative(
        oe_issue_date_t{2018, 7, 32, 0, 0, 0}, OE_INVALID_UTC_DATE_TIME);
    TestNegative(
        oe_issue_date_t{2018, 8, 32, 0, 0, 0}, OE_INVALID_UTC_DATE_TIME);
    TestNegative(
        oe_issue_date_t{2018, 9, 31, 0, 0, 0}, OE_INVALID_UTC_DATE_TIME);
    TestNegative(
        oe_issue_date_t{2018, 10, 32, 0, 0, 0}, OE_INVALID_UTC_DATE_TIME);
    TestNegative(
        oe_issue_date_t{2018, 11, 31, 0, 0, 0}, OE_INVALID_UTC_DATE_TIME);
    TestNegative(
        oe_issue_date_t{2018, 12, 32, 0, 0, 0}, OE_INVALID_UTC_DATE_TIME);
    ...
    // Unless divisible by 400
    TestNegative(
        oe_issue_date_t{2000, 2, 30, 0, 0, 0}, OE_INVALID_UTC_DATE_TIME);
