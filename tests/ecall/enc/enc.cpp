...
OE_ECALL void Test(void* args_)
{
    ...
    args->base_heap_page = ((uint64_t)__oe_get_heap_base() - (uint64_t)args->base) / OE_PAGE_SIZE; //oe_base_heap_page;
    args->num_heap_pages = __oe_get_heap_size() / OE_PAGE_SIZE;     // oe_num_heap_pages;
