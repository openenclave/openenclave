...
def enable_oeenclave_debug(process, oe_enclave_addr, enclave_path):
    ...
    thread_binding_blob = read_from_memory(process, thread_binding_addr, THREAD_BINDING_HEADER_LENGTH)
    ...
    while thread_binding_tuple[0] > 0 :
        ...
        set_tcs_debug_flag(process, thread_binding_tuple[0])
