...
class ImageLoadBreakpoint(gdb.Breakpoint):
    def __init__(self):
        gdb.Breakpoint.__init__ (self, spec="oe_notify_debugger_image_load", internal=1)
...
class ImageUnloadBreakpoint(gdb.Breakpoint):
    def __init__(self):
        gdb.Breakpoint.__init__ (self, spec="oe_notify_debugger_image_unload", internal=1)
