...
static long OE_GetRegSetHandler(
    pid_t pid, 
    void* addr, 
    void* data)
{
...
static long OE_SetRegSetHandler(
    pid_t pid, 
    void* addr, 
    void* data)
{
...
static long OE_SingleStepHandler(
    pid_t pid, 
    void* addr, 
    void* data)
{
