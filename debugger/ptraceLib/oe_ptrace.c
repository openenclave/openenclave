...
static long oe_get_gpr_handler(pid_t pid, void* addr, void* data)
{
    if (!data)
    {
        return -1;
...
static long oe_set_gpr_handler(pid_t pid, void* addr, void* data)
{
    if (!data)
    {
        return -1;
...
static long oe_get_fpr_handler(pid_t pid, void* addr, void* data)
{
    if (!data)
    {
        return -1;
...
static long oe_set_fpr_handler(pid_t pid, void* addr, void* data)
{
    if (!data)
    {
        return -1;
...
static long oe_get_reg_set_handler(pid_t pid, void* addr, void* data)
{
    if (!data)
    {
        return -1;
...
static long oe_set_reg_set_handler(pid_t pid, void* addr, void* data)
{
    if (!data)
    {
        return -1;
...
static long oe_single_step_handler(pid_t pid, void* addr, void* data)
{
...
typedef long (*oe_ptrace_request_handler)(pid_t, void*, void*);
...
long ptrace(oe_ptrace_request_type __request, ...)
{
    pid_t pid;
    void* addr;
    void* data;
