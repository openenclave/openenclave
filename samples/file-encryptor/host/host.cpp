    ...
    const char* output_file)
{
        ...
        bytes_read > 0)
    {
        ...
        // The data size is always padded to align with DATA_BLOCK_SIZE during encryption.
        // Therefore, remove the padding (if any) from the last block during decryption.
