...
class Attestation
{
  ...
  public:
    ...
    bool generate_remote_attestation_evidence(
        const uint8_t* data,
        size_t data_size,
        uint8_t** evidence,
     ...
     * the enclave signer_id and unique_id values are tested to establish trust
     * of the enclave that generated the remote evidence.
     */
    bool attest_remote_attestation_evidence(
