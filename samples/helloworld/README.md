...
[Getting started with the Open Enclave edger8r](https://github.com/Microsoft/openenclave/tree/v0.4.x/docs/GettingStartedDocs/Edger8rGettingStarted.md).
...
These parameters are described in the [Enclave Building and Signing](https://github.com/Microsoft/openenclave/tree/v0.4.x/docs/GettingStartedDocs/buildandsign.md#signing-the-enclave) document.
...
an enclave host runtime, with enclave management functions exposed through [openenclave/host.h](https://openenclave.io/apidocs/v0.4/host_8h.html).
