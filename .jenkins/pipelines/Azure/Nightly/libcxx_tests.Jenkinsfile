...
try {
    ...
    parallel "Libcxx ACC2004 clang-8 Debug" :          { ACCLibcxxTest(FOCAL_LABEL, 'clang-8', 'Debug') },
             "Libcxx ACC2004 clang-8 Release" :        { ACCLibcxxTest(FOCAL_LABEL, 'clang-8','Release') },
             "Libcxx ACC2004 clang-8 RelWithDebInfo" : { ACCLibcxxTest(FOCAL_LABEL, 'clang-8', 'RelWithDebInfo') },
