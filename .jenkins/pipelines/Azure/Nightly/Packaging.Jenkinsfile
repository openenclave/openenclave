...
pipeline {
    ...
    parameters {
        ...
        string(name: 'UBUNTU_1804_LABEL',     defaultValue: 'ACC-1804',                 description: '[Optional] Jenkins agent label to use for Ubuntu 18.04')
            ...
            steps {
                script {
                    parallel([
                        ...
                        "Ubuntu 18.04 SGX1FLC Package Debug LVI":          { tests.LinuxPackaging(params.UBUNTU_1804_LABEL, params.COMPILER, 'Debug', 'ControlFlow') },
                        "Ubuntu 18.04 SGX1FLC Package RelWithDebInfo LVI": { tests.LinuxPackaging(params.UBUNTU_1804_LABEL, params.COMPILER, 'RelWithDebInfo', 'ControlFlow') },
