...
OE_INLINE void _td_set_host_signal_unmasked(oe_sgx_td_t* td, uint64_t value)
{
    if (!td)
        return;
...
{
    _td_set_host_signal_unmasked(td, 0);
}

void oe_sgx_td_unmask_host_signal(oe_sgx_td_t* td)
{
    _td_set_host_signal_unmasked(td, 1);
}
...
OE_INLINE bool _td_set_host_signal_bitmask(
    oe_sgx_td_t* td,
    int signal_number,
    bool set_bit)
{
...
{
    return _td_set_host_signal_bitmask(td, signal_number, 1 /* set */);
}

bool oe_sgx_td_unregister_host_signal(oe_sgx_td_t* td, int signal_number)
{
    return _td_set_host_signal_bitmask(td, signal_number, 0 /* clear */);
}
