...
**==============================================================================
*/
void _handle_init_enclave(uint64_t arg_in)
{
    ...
    uint64_t* output_arg2)
{
    ...
    switch (func)
    {
        ...
        {
            _oe_virtual_exception_dispatcher(td, arg_in, &arg_out);
            break;
        }
        case OE_FUNC_INIT_ENCLAVE:
        {
            _handle_init_enclave(arg_in);
            break;
        }
        case OE_FUNC_GET_REPORT:
        {
            arg_out = _handle_get_report(arg_in);
            break;
        }
        default:
        {
...
Exit:
    ...
    *output_arg1 = oe_make_call_arg1(OE_CODE_ERET, func, 0);
    *output_arg2 = arg_out;
    return;
}
