...
../SimSecTempSensor_t.c: ../../SimSecTempSensor.edl
	$(OEEDGER8R) --trusted --trusted-dir .. --search-path "$(NEW_PLATFORMS_PATH)Inc$(OEPATHSEP)$(OE_SDK_ROOT_PATH)include" ../../SimSecTempSensor.edl

../SimSecTempSensor_t.h: ../../SimSecTempSensor.edl
	$(OEEDGER8R) --trusted --trusted-dir .. --search-path "$(NEW_PLATFORMS_PATH)Inc$(OEPATHSEP)$(OE_SDK_ROOT_PATH)include" ../../SimSecTempSensor.edl

# Add the c file generated from your EDL file here
srcs-y             += ../SimSecTempSensor_t.c
