...
// Include the untrusted SimSecTempSensor header that is generated
// during the build. This file is generated by calling the
// sdk tool sgx_edger8r against the SimSecTempSensor.edl file.
#include "SimSecTempSensor_u.h"

#ifdef OE_USE_SGX
#define TA_BIN "SimSecTempSensorEnc"
#else
#define TA_BIN "97d140f4-5f59-4d1f-9735-cb21d49e7eb7"
#endif
...
int main(int argc, const char* argv[])
{
    ...
    while (TRUE)
    {
        ...
        printf(
            "Read value: %d, signature size: %lu\n",
            sensor_value,
            signature_size);
