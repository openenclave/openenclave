...
underlying platform- and enclave-specific behaviors are abstracted away.

# Quick Start

On either Windows or Linux, begin with an empty directory and do:
...
cmake -DOE_TEE=TZ -DCMAKE_TOOLCHAIN_FILE=../../3rdparty/openenclave/new_platforms/cmake/linux-arm-v6.cmake -DTA_DEV_KIT_DIR=path/to/optee_os/out/arm/export-ta_arm32 ../..
cmake --build . -- -j
...
cmake -DOE_TEE=TZ -DCMAKE_TOOLCHAIN_FILE=../../3rdparty/openenclave/new_platforms/cmake/linux-aarch64-v6.cmake -DTA_DEV_KIT_DIR=path/to/optee_os/out/arm/export-ta_arm64 ../..
cmake --build . -- -j
