...
#ifndef _OE_INTERNAL_POSIX_DEVICE_OPS_H
#define _OE_INTERNAL_POSIX_DEVICE_OPS_H
...
typedef struct _oe_device_ops
{
    ...
    // TODO: find a way not to expose the host file descriptor through the
    // generic devices interface.
...
#endif // _OE_INTERNAL_POSIX_DEVICE_OPS_H
