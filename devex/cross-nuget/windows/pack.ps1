...
New-Item -ItemType Directory -Path Pack\lib\native\win\sgx\default\debug\enclave\clang-11 | Out-Null
New-Item -ItemType Directory -Path Pack\lib\native\win\sgx\default\debug\host\msvc-14.16.27023 | Out-Null

New-Item -ItemType Directory -Path Pack\lib\native\win\sgx\default\release\enclave\clang-11 | Out-Null
...
$LibCopyRules | ForEach-Object {
    ...
    Copy-Item -Path $EnclaveLibs -Destination (Join-Path -Path $_.Destination -ChildPath enclave\clang-11)
