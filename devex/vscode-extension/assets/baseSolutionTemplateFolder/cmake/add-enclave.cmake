...
function (add_enclave_sgx)
  ...
  add_custom_command(
    ...
    DEPENDS ${ENCLAVE_TARGET} ${ENCLAVE_TARGET}.conf
            ${ENCLAVE_TARGET}-private.pem
    COMMAND
      openenclave::oesign sign -e $<TARGET_FILE:${ENCLAVE_TARGET}> -c
      ${CMAKE_CURRENT_SOURCE_DIR}/${ENCLAVE_TARGET}.conf -k
      ${ENCLAVE_TARGET}-private.pem)
...
macro (add_enclave_optee)
  ...
  add_custom_target(
    ...
    COMMAND
      ${OE_PACKAGE_PREFIX}/sign.py --key ${ENCLAVE_KEY} --uuid ${ENCLAVE_UUID}
      --version 0 --in
