...
function(add_enclave_executable BIN SIGNCONF KEYFILE)
	...
	target_link_libraries(${BIN} oeenclave oecrypto mbedcrypto)
...
function(add_cxx_enclave_executable BIN SIGNCONF KEYFILE)
	add_executable(${BIN} ${ARGN})

	# enclaves depend on the oeenclave lib
	target_link_libraries(${BIN} oeenclave oelibcxx oecrypto mbedcrypto)
...
endfunction(add_cxx_enclave_executable)
