...
## HOST_NAME : Host application executable file name.

function(add_wnd_enclave_tests TESTNAME HOST_FILE)
	...
	add_custom_command(OUTPUT ${TESTNAME}_windows_include
		...
		DEPENDS ${CMAKE_CURRENT_BINARY_DIR}/host/${HOST_FILE} ${LINUX_BIN_DIR}/${TESTNAME}/enc/${TESTNAME}_enc.signed.so
	...
	add_test(tests/${TESTNAME} ${CMAKE_CURRENT_BINARY_DIR}/host/${HOST_FILE} ${CMAKE_CURRENT_BINARY_DIR}/host/${TESTNAME}_enc.signed.so)
