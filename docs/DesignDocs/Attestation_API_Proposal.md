...
endorsements.
  ...
  format ID. This flag is deprecated in release v0.13 - evidence generated by oe_get_evidene() will have the header containing the format ID.
...
`format_id` parameter.
* `NULL`:
  * The input evidence is generated by `oe_get_evidence()` for any format or
  the legacy API function `oe_get_report()` with the `OE_REPORT_FLAGS_REMOTE_ATTESTATION` flag.
* `OE_FORMAT_UUID_SGX_LOCAL_ATTESTATION`:
...
will be prefixed with an `oe_attestation_header`.
