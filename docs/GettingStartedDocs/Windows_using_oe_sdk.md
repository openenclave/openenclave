...
| include\openenclave\3rdparty | Headers for libc and libcxx libraries for use inside the enclave.<br>See the API Reference section for supported functions. |
...
| lib\openenclave\enclave      | Libraries for linking into the enclave, including libc, libcxx, and OpenSSL libraries for Open Enclave. |
