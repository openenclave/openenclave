...
To install the Open Enclave Host-Verify SDK instead, see [installation instructions for Ubuntu 18.04](https://github.com/microsoft/openenclave/blob/master/docs/GettingStartedDocs/install_host_verify_Ubuntu_18.04.md).
...
You will also need a build machine running Ubuntu 18.04. This can be
