...
```bash
sudo apt -y install clang-7 libssl-dev gdb libsgx-enclave-common libsgx-enclave-common-dev libprotobuf10 libsgx-qe3-logic libsgx-pce-logic libsgx-dcap-ql libsgx-dcap-ql-dev az-dcap-client open-enclave
```
