...
OE_INLINE bool oe_sgx__load_is_simulation(const oe_sgx__load_context_t* context)
{
    return (context && (context->attributes & OE_ENCLAVE_FLAG_SIMULATE));
}

OE_INLINE bool oe_sgx__load_is_debug(const oe_sgx__load_context_t* context)
{
