 ...
 */
// Open Enclave: Use pthread API to support threading.
 ...
 */
// Open Enclave: enable to support network I/O in enclaves
 ...
 *
 */
// Open Enclave: Drop PSA to minimize TCB.
