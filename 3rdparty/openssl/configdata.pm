...
our %unified_info = (
    ...
    "generate" => {
        ...
        "crypto/bn/rsaz-avx512.s" => [
            "openssl/crypto/bn/asm/rsaz-avx512.pl"
        ],
...
unless (caller) {
    ...
    use lib '/home/luongminh97/openenclave/3rdparty/openssl/openssl/util/perl';
    use OpenSSL::fallback '/home/luongminh97/openenclave/3rdparty/openssl/openssl/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/home/luongminh97/openenclave/3rdparty/openssl/openssl/Configurations';
        use gentemplate;
