/*
 * WARNING: do not edit!
 * Generated by include/openssl/pkcs12.h from include/openssl/pkcs12.h.in
 *
...
/* The macro is expected to be used only internally. Kept for backwards
 * compatibility. */
...
#define PKCS12_MAKE_SHKEYBAG PKCS12_SAFEBAG_create_pkcs8_encrypt
...
#endif
#ifndef OPENSSL_NO_DEPRECATED_1_1_0
    OSSL_DEPRECATEDIN_1_1_0 ASN1_TYPE* PKCS12_get_attr(
    ...
    const ASN1_TYPE* PKCS12_SAFEBAG_get0_attr(
        const PKCS12_SAFEBAG* bag,
        int attr_nid);
    ...
    X509* PKCS12_SAFEBAG_get1_cert_ex(
        const PKCS12_SAFEBAG* bag,
        OSSL_LIB_CTX* libctx,
        const char* propq);
    X509* PKCS12_SAFEBAG_get1_cert(const PKCS12_SAFEBAG* bag);
    X509_CRL* PKCS12_SAFEBAG_get1_crl_ex(
        const PKCS12_SAFEBAG* bag,
        OSSL_LIB_CTX* libctx,
        const char* propq);
    ...
    const PKCS8_PRIV_KEY_INFO* PKCS12_SAFEBAG_get0_p8inf(
        const PKCS12_SAFEBAG* bag);
    const X509_SIG* PKCS12_SAFEBAG_get0_pkcs8(const PKCS12_SAFEBAG* bag);

    PKCS12_SAFEBAG* PKCS12_SAFEBAG_create_cert(X509* x509);
    PKCS12_SAFEBAG* PKCS12_SAFEBAG_create_crl(X509_CRL* crl);
    PKCS12_SAFEBAG* PKCS12_SAFEBAG_create_secret(
        int type,
        int vtype,
    ...
    PKCS12_SAFEBAG* PKCS12_item_pack_safebag(
        ...
        int nid1,
        int nid2);
    PKCS8_PRIV_KEY_INFO* PKCS8_decrypt(
        const X509_SIG* p8,
        const char* pass,
        int passlen);
    PKCS8_PRIV_KEY_INFO* PKCS8_decrypt_ex(
        const X509_SIG* p8,
        const char* pass,
        int passlen,
        OSSL_LIB_CTX* ctx,
    ...
    PKCS8_PRIV_KEY_INFO* PKCS12_decrypt_skey(
        ...
        const char* pass,
        int passlen);
    PKCS8_PRIV_KEY_INFO* PKCS12_decrypt_skey_ex(
        const PKCS12_SAFEBAG* bag,
        const char* pass,
        int passlen,
        OSSL_LIB_CTX* ctx,
    ...
    int PKCS12_add_friendlyname_asc(
        ...
        const char* name,
        int namelen);
    int PKCS12_add_friendlyname_utf8(
        PKCS12_SAFEBAG* bag,
        const char* name,
        int namelen);
    int PKCS12_add_CSPName_asc(
        PKCS12_SAFEBAG* bag,
        const char* name,
        int namelen);
    ...
    void PKCS12_SAFEBAG_set0_attrs(
        PKCS12_SAFEBAG* bag,
    ...
    unsigned char* PKCS12_pbe_crypt(
        ...
        int* datalen,
        int en_de);
    unsigned char* PKCS12_pbe_crypt_ex(
        const X509_ALGOR* algor,
        const char* pass,
        int passlen,
        const unsigned char* in,
    ...
    void* PKCS12_item_decrypt_d2i(
        ...
        int zbuf);
    void* PKCS12_item_decrypt_d2i_ex(
        const X509_ALGOR* algor,
        const ASN1_ITEM* it,
        const char* pass,
        int passlen,
    ...
    int PKCS12_setup_mac(
        ...
        int saltlen,
        const EVP_MD* md_type);
    unsigned char* OPENSSL_asc2uni(
        const char* asc,
        int asclen,
        unsigned char** uni,
        int* unilen);
    char* OPENSSL_uni2asc(const unsigned char* uni, int unilen);
    unsigned char* OPENSSL_utf82uni(
        const char* asc,
        int asclen,
        unsigned char** uni,
        int* unilen);
    ...
    PKCS12_SAFEBAG* PKCS12_add_cert(
    ...
    PKCS12_SAFEBAG* PKCS12_add_secret(
        STACK_OF(PKCS12_SAFEBAG) * *pbags,
        int nid_type,
        const unsigned char* value,
        int len);
