/*
 * WARNING: do not edit!
 * Generated by include/openssl/cms.h from include/openssl/cms.h.in
 *
...
#define sk_CMS_RevocationInfoChoice_set_cmp_func(sk, cmp) ((sk_CMS_RevocationInfoChoice_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_CMS_RevocationInfoChoice_sk_type(sk), ossl_check_CMS_RevocationInfoChoice_compfunc_type(cmp)))
    ...
    CMS_ContentInfo* CMS_ContentInfo_new_ex(
        OSSL_LIB_CTX* libctx,
        const char* propq);
...
#define CMS_NO_SIGNING_TIME 0x400000
    ...
    CMS_ContentInfo* SMIME_read_CMS_ex(
        BIO* bio,
        int flags,
        BIO** bcont,
        CMS_ContentInfo** ci);
    ...
    CMS_ContentInfo* CMS_data_create_ex(
        BIO* in,
        unsigned int flags,
        OSSL_LIB_CTX* libctx,
        const char* propq);
    ...
    int CMS_digest_verify(
        ...
        BIO* out,
        unsigned int flags);
    CMS_ContentInfo* CMS_digest_create(
        BIO* in,
        const EVP_MD* md,
        unsigned int flags);
    CMS_ContentInfo* CMS_digest_create_ex(
        BIO* in,
        const EVP_MD* md,
        unsigned int flags,
        OSSL_LIB_CTX* libctx,
    ...
    CMS_ContentInfo* CMS_encrypt(
        ...
        const EVP_CIPHER* cipher,
        unsigned int flags);
    CMS_ContentInfo* CMS_encrypt_ex(
        STACK_OF(X509) * certs,
        BIO* in,
        const EVP_CIPHER* cipher,
        unsigned int flags,
    ...
    CMS_ContentInfo* CMS_EnvelopedData_create_ex(
        const EVP_CIPHER* cipher,
        OSSL_LIB_CTX* libctx,
        const char* propq);
    ...
    CMS_RecipientInfo* CMS_add1_recipient_cert(
        ...
        X509* recip,
        unsigned int flags);
    CMS_RecipientInfo* CMS_add1_recipient(
        CMS_ContentInfo* cms,
        X509* recip,
    ...
    CMS_RevocationInfoChoice* CMS_add0_RevocationInfoChoice(
        CMS_ContentInfo* cms);
    ...
    int CMS_signed_get_attr_by_NID(
    ...
    *CMS_RecipientInfo_kari_get0_reks(CMS_RecipientInfo* ri);
    ...
    int CMS_RecipientInfo_kari_set0_pkey_and_peer(
        CMS_RecipientInfo* ri,
        EVP_PKEY* pk,
        X509* peer);
