/*
 * WARNING: do not edit!
 * Generated by include/openssl/x509_vfy.h from include/openssl/x509_vfy.h.in
 *
...
#define X509_TRUST_UNTRUSTED 3
    ...
    typedef int (*X509_STORE_CTX_get_crl_fn)(
        ...
        X509* x);
    typedef int (
        *X509_STORE_CTX_check_crl_fn)(X509_STORE_CTX* ctx, X509_CRL* crl);
    typedef int (*X509_STORE_CTX_cert_crl_fn)(
        X509_STORE_CTX* ctx,
        X509_CRL* crl,
        X509* x);
    typedef int (*X509_STORE_CTX_check_policy_fn)(X509_STORE_CTX* ctx);
    typedef STACK_OF(X509) * (*X509_STORE_CTX_lookup_certs_fn)(
                                 X509_STORE_CTX* ctx,
                                 const X509_NAME* nm);
...
#define X509_LOOKUP_load_file_ex(x, name, type, libctx, propq) \
    X509_LOOKUP_ctrl_ex(                                       \
        (x), X509_L_FILE_LOAD, (name), (long)(type), NULL, (libctx), (propq))

#define X509_LOOKUP_load_store_ex(x, name, libctx, propq) \
    X509_LOOKUP_ctrl_ex(                                  \
        (x), X509_L_LOAD_STORE, (name), 0, NULL, (libctx), (propq))

#define X509_LOOKUP_add_store_ex(x, name, libctx, propq) \
    X509_LOOKUP_ctrl_ex(                                 \
        (x), X509_L_ADD_STORE, (name), 0, NULL, (libctx), (propq))
...
#define X509_STORE_get_ex_new_index(l, p, newf, dupf, freef) \
    ...
    X509_STORE_CTX* X509_STORE_CTX_new_ex(
        OSSL_LIB_CTX* libctx,
        const char* propq);
    ...
    X509_STORE_CTX_check_revocation_fn X509_STORE_CTX_get_check_revocation(
        const X509_STORE_CTX* ctx);
    void X509_STORE_CTX_set_get_crl(
        X509_STORE_CTX* ctx,
        X509_STORE_CTX_get_crl_fn get_crl);
...
#define X509_STORE_CTX_get_ex_new_index(l, p, newf, dupf, freef) \
    CRYPTO_get_ex_new_index(                                     \
        CRYPTO_EX_INDEX_X509_STORE_CTX, l, p, newf, dupf, freef)
    ...
    void X509_STORE_CTX_set_time(
        ...
        unsigned long flags,
        time_t t);
    void X509_STORE_CTX_set_current_reasons(
        X509_STORE_CTX* ctx,
        unsigned int current_reasons);

    X509_POLICY_TREE* X509_STORE_CTX_get0_policy_tree(
        const X509_STORE_CTX* ctx);
...
#define DANE_FLAG_NO_DANE_EE_NAMECHECKS (1L << 0)
    ...
    void X509_VERIFY_PARAM_set_hostflags(
        X509_VERIFY_PARAM* param,
        unsigned int flags);
    unsigned int X509_VERIFY_PARAM_get_hostflags(
...
#define X509_PCY_TREE_EXPLICIT 4 /* Explicit policy required */
    ...
    *X509_policy_tree_get0_user_policies(const X509_POLICY_TREE* tree);
    ...
    X509_POLICY_NODE* X509_policy_level_get0_node(
        const X509_POLICY_LEVEL* level,
        int i);

    const ASN1_OBJECT* X509_policy_node_get0_policy(
