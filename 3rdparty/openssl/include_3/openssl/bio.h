/*
 * WARNING: do not edit!
 * Generated by include/openssl/bio.h from include/openssl/bio.h.in
 *
...
#define BIO_FLAGS_IN_EOF 0x800
    ...
    /* the BIO FLAGS values 0x1000 to 0x8000 are reserved for internal KTLS
     * flags */
...
#define BIO_cb_post(a) ((a)&BIO_CB_RETURN)
    ...
    OSSL_DEPRECATEDIN_3_0 void BIO_set_callback(
        BIO* b,
        BIO_callback_fn callback);
    OSSL_DEPRECATEDIN_3_0 long BIO_debug_callback(
        BIO* bio,
        int cmd,
        const char* argp,
        int argi,
...
#define BIO_rw_filename(b, name) \
    (int)BIO_ctrl(               \
        b, BIO_C_SET_FILENAME, BIO_CLOSE | BIO_FP_READ | BIO_FP_WRITE, name)
...
#define BIO_dgram_get_local_addr_enable(b, penable) \
    (int)BIO_ctrl(                                  \
        (b), BIO_CTRL_DGRAM_GET_LOCAL_ADDR_ENABLE, 0, (char*)(penable))
...
#define BIO_sock_cleanup() \
    ...
    OSSL_DEPRECATEDIN_1_1_0 int BIO_get_port(
        const char* str,
        unsigned short* port_ptr);
    OSSL_DEPRECATEDIN_1_1_0 int BIO_get_host_ip(
        const char* str,
        unsigned char* ip);
    OSSL_DEPRECATEDIN_1_1_0 int BIO_get_accept_socket(
        char* host_port,
        int mode);
...
#undef ossl_bio__printf__
    ...
    OSSL_DEPRECATEDIN_3_5 int (
        *BIO_meth_get_write(const BIO_METHOD* biom))(BIO*, const char*, int);
    OSSL_DEPRECATEDIN_3_5 int (*BIO_meth_get_write_ex(
        const BIO_METHOD* biom))(BIO*, const char*, size_t, size_t*);
    OSSL_DEPRECATEDIN_3_5 int (*BIO_meth_get_sendmmsg(const BIO_METHOD* biom))(
        BIO*,
        BIO_MSG*,
        size_t,
        size_t,
    ...
    OSSL_DEPRECATEDIN_3_5 int (*BIO_meth_get_read_ex(
        const BIO_METHOD* biom))(BIO*, char*, size_t, size_t*);
    OSSL_DEPRECATEDIN_3_5 int (*BIO_meth_get_recvmmsg(const BIO_METHOD* biom))(
        BIO*,
        BIO_MSG*,
        size_t,
        size_t,
    ...
    OSSL_DEPRECATEDIN_3_5 long (
        *BIO_meth_get_ctrl(const BIO_METHOD* biom))(BIO*, int, long, void*);
    OSSL_DEPRECATEDIN_3_5 int (*BIO_meth_get_create(const BIO_METHOD* bion))(
        BIO*);
    OSSL_DEPRECATEDIN_3_5 int (*BIO_meth_get_destroy(const BIO_METHOD* biom))(
        BIO*);
    OSSL_DEPRECATEDIN_3_5 long (*BIO_meth_get_callback_ctrl(
        const BIO_METHOD* biom))(BIO*, int, BIO_info_cb*);
#endif
#ifdef __cplusplus
}
#endif
