/*
 * WARNING: do not edit!
 * Generated by include/openssl/asn1.h from include/openssl/asn1.h.in
 *
...
#define TYPEDEF_I2D_OF(type) \
    typedef int i2d_of_##type(const type*, unsigned char**)
...
#define ASN1_STRFLGS_SHOW_TYPE 0x40
     ...
     * content octets or DER encoding). We can only dump non character strings
     * or everything. If we don't dump 'unknown' they are interpreted as
     * character strings with 1 octet per character and are subject to the usual
     * escaping options.
     */
...
#define ASN1_STRFLGS_DUMP_UNKNOWN 0x100
    ...
    /*
     * These determine what 'dumping' does, we can dump the content octets or
     * the DER encoding: both use the RFC2253 #XXXXX notation.
     */
...
#define B_ASN1_DISPLAYTEXT                                       \
    ...
    ASN1_TYPE* ASN1_TYPE_pack_sequence(
        const ASN1_ITEM* it,
        void* s,
        ASN1_TYPE** t);
    ...
    DECLARE_ASN1_FUNCTIONS_name(ASN1_STRING, ASN1_PRINTABLE)
        ...
        DECLARE_ASN1_FUNCTIONS_name(ASN1_STRING, DIRECTORYSTRING)
            DECLARE_ASN1_FUNCTIONS_name(
                ASN1_STRING,
                DISPLAYTEXT) DECLARE_ASN1_FUNCTIONS(ASN1_PRINTABLESTRING)
                DECLARE_ASN1_FUNCTIONS(ASN1_T61STRING) DECLARE_ASN1_FUNCTIONS(
                    ASN1_IA5STRING) DECLARE_ASN1_FUNCTIONS(ASN1_GENERALSTRING)
...
#define ASN1_i2d_bio_of(type, i2d, out, x) \
    (ASN1_i2d_bio(                         \
        CHECKED_I2D_OF(type, i2d), out, CHECKED_PTR_OF(const type, x)))
    ...
    void* ASN1_item_unpack_ex(
        const ASN1_STRING* oct,
        const ASN1_ITEM* it,
        OSSL_LIB_CTX* libctx,
        const char* propq);

    ASN1_STRING* ASN1_item_pack(
        void* obj,
        const ASN1_ITEM* it,
    ...
    ASN1_VALUE* ASN1_item_new_ex(
        const ASN1_ITEM* it,
        OSSL_LIB_CTX* libctx,
        const char* propq);
    void ASN1_item_free(ASN1_VALUE* val, const ASN1_ITEM* it);
    ASN1_VALUE* ASN1_item_d2i_ex(
        ASN1_VALUE** val,
        const unsigned char** in,
        long len,
        const ASN1_ITEM* it,
