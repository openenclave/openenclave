/*
 * WARNING: do not edit!
 * Generated by include/openssl/x509.h from include/openssl/x509.h.in
 *
...
#define sk_X509_INFO_set_cmp_func(sk, cmp) ((sk_X509_INFO_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_X509_INFO_sk_type(sk), ossl_check_X509_INFO_compfunc_type(cmp)))
    ...
    /*
     * The next 2 structures and their 8 routines are used to manipulate
     * Netscape's spki structures - useful if you are writing a CA web page
     */
...
#define X509_name_cmp(a, b) X509_NAME_cmp((a), (b))
    ...
    int X509_digest(
        ...
        unsigned char* md,
        unsigned int* len);
    ASN1_OCTET_STRING* X509_digest_sig(
        const X509* cert,
        EVP_MD** md_used,
        int* md_is_fallback);
    int X509_CRL_digest(
...
#define X509_CRL_http_nbio(rctx, pcrl) \
    ...
    OSSL_DEPRECATEDIN_3_0 int i2d_ECPrivateKey_fp(
        FILE* fp,
        const EC_KEY* eckey);
#endif /* OPENSSL_NO_EC */
    ...
    OSSL_DEPRECATEDIN_3_0 int i2d_ECPrivateKey_bio(
        BIO* bp,
        const EC_KEY* eckey);
#endif /* OPENSSL_NO_EC */
#endif /* OPENSSL_NO_DEPRECATED_3_0 */
    ...
    DECLARE_ASN1_ENCODE_FUNCTIONS_only_attr(
        ...
        DECLARE_ASN1_ENCODE_FUNCTIONS_only_attr(
            ...
            DECLARE_ASN1_ENCODE_FUNCTIONS_only_attr(
                ...
                DECLARE_ASN1_FUNCTIONS(X509_SIG) void X509_SIG_get0(
                    const X509_SIG* sig,
...
#define X509_REQ_VERSION_1 0
    ...
    STACK_OF(X509_EXTENSION) *
        X509_REQ_get_extensions(OSSL_FUTURE_CONST X509_REQ* req);
...
#define X509_NAME_hash(x) X509_NAME_hash_ex(x, NULL, NULL, NULL)
    OSSL_DEPRECATEDIN_3_0 int X509_certificate_type(
        const X509* x,
        const EVP_PKEY* pubkey);
#endif
    unsigned long X509_NAME_hash_ex(
        const X509_NAME* x,
        OSSL_LIB_CTX* libctx,
        const char* propq,
        int* ok);
    ...
    STACK_OF(X509_EXTENSION) * X509v3_add_ext(
                                   ...
                                   X509_EXTENSION* ex,
                                   int loc);
    STACK_OF(X509_EXTENSION) * X509v3_add_extensions(
                                   STACK_OF(X509_EXTENSION) * *target,
                                   const STACK_OF(X509_EXTENSION) * exts);
    ...
    X509_ALGOR* PKCS5_pbe2_set_iv(
        ...
        unsigned char* aiv,
        int prf_nid);
    X509_ALGOR* PKCS5_pbe2_set_iv_ex(
        const EVP_CIPHER* cipher,
        int iter,
        unsigned char* salt,
        int saltlen,
    ...
    X509_ALGOR* PKCS5_pbkdf2_set(
        ...
        int prf_nid,
        int keylen);
    X509_ALGOR* PKCS5_pbkdf2_set_ex(
        int iter,
        unsigned char* salt,
        int saltlen,
        int prf_nid,
    ...
    int PKCS8_pkey_add1_attr_by_NID(
        ...
        const unsigned char* bytes,
        int len);
    int PKCS8_pkey_add1_attr_by_OBJ(
        PKCS8_PRIV_KEY_INFO* p8,
        const ASN1_OBJECT* obj,
        int type,
        const unsigned char* bytes,
    ...
    void X509_PUBKEY_set0_public_key(
        X509_PUBKEY* pub,
        unsigned char* penc,
        int penclen);
