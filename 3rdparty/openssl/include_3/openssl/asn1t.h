/*
 * WARNING: do not edit!
 * Generated by include/openssl/asn1t.h from include/openssl/asn1t.h.in
 *
...
#define ASN1_SEQUENCE_enc(tname, enc, cb)                                \
    static const ASN1_AUX tname##_aux = {                                \
        NULL, ASN1_AFLG_ENCODING, 0, 0, cb, offsetof(tname, enc), NULL}; \
    ASN1_SEQUENCE(tname)
...
#define ASN1_TFLG_EMBED (0x1 << 12)
    ...
    typedef int ASN1_ex_new_ex_func(
        ASN1_VALUE** pval,
        const ASN1_ITEM* it,
        OSSL_LIB_CTX* libctx,
        const char* propq);
     ...
     * informational callback. The "informational callback" is called at various
     * points during the ASN1 encoding and decoding. It can be used to provide
     * minor customisation of the structures used. This is most useful where the
     * supplied routines *almost* do the right thing but need some extra help at
     * a few points. If the callback returns zero then it is assumed a fatal
     * error has occurred and the main operation should be abandoned. If major
     * changes in the default behaviour are required then an external type is
     * more appropriate.
     * For the operations ASN1_OP_I2D_PRE, ASN1_OP_I2D_POST, ASN1_OP_PRINT_PRE,
     * and ASN1_OP_PRINT_POST, meanwhile a variant of the callback with const
     * parameter 'in' is provided to make clear statically that its input is not
     * modified. If and only if this variant is in use the flag
     * ASN1_AFLG_CONST_CB must be set.
     */

    typedef int ASN1_aux_cb(
        int operation,
        ASN1_VALUE** in,
        const ASN1_ITEM* it,
        void* exarg);
    typedef int ASN1_aux_const_cb(
        int operation,
        const ASN1_VALUE** in,
        const ASN1_ITEM* it,
        void* exarg);
    ...
    typedef struct ASN1_AUX_st
    {
        ...
        ASN1_aux_const_cb*
            asn1_const_cb; /* for ASN1_OP_I2D_ and ASN1_OP_PRINT_ */
    } ASN1_AUX;
...
#define IMPLEMENT_ASN1_ENCODE_FUNCTIONS_fname(stname, itname, fname)    \
    ...
    {                                                                   \
        return ASN1_item_i2d(                                           \
            (const ASN1_VALUE*)a, out, ASN1_ITEM_rptr(itname));         \
    }

#define IMPLEMENT_ASN1_NDEF_FUNCTION(stname)                      \
    int i2d_##stname##_NDEF(const stname* a, unsigned char** out) \
    {                                                             \
        return ASN1_item_ndef_i2d(                                \
            (const ASN1_VALUE*)a, out, ASN1_ITEM_rptr(stname));   \
    }

#define IMPLEMENT_STATIC_ASN1_ENCODE_FUNCTIONS(stname)            \
    static stname* d2i_##stname(                                  \
        stname** a, const unsigned char** in, long len)           \
    {                                                             \
        return (stname*)ASN1_item_d2i(                            \
            (ASN1_VALUE**)a, in, len, ASN1_ITEM_rptr(stname));    \
    }                                                             \
...
#define IMPLEMENT_ASN1_PRINT_FUNCTION_fname(stname, itname, fname)            \
    int fname##_print_ctx(                                                    \
        BIO* out, const stname* x, int indent, const ASN1_PCTX* pctx)         \
    {                                                                         \
        return ASN1_item_print(                                               \
            out, (const ASN1_VALUE*)x, indent, ASN1_ITEM_rptr(itname), pctx); \
    }
