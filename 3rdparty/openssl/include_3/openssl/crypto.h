/*
 * WARNING: do not edit!
 * Generated by include/openssl/crypto.h from include/openssl/crypto.h.in
 *
...
#define OPENSSL_aligned_alloc(num, alignment, freeptr) \
    CRYPTO_aligned_alloc(num, alignment, freeptr, OPENSSL_FILE, OPENSSL_LINE)
...
#define CRYPTO_EX_INDEX__COUNT 18
    ...
    typedef int CRYPTO_EX_dup(
        ...
        long argl,
        void* argp);
    __owur int CRYPTO_get_ex_new_index(
        int class_index,
        long argl,
        void* argp,
...
#define CRYPTO_get_dynlock_destroy_callback() (NULL)
    ...
    typedef void* (
        *CRYPTO_realloc_fn)(void* addr, size_t num, const char* file, int line);
    ...
    OSSL_CRYPTO_ALLOC void* CRYPTO_malloc(
        size_t num,
        const char* file,
        int line);
    OSSL_CRYPTO_ALLOC void* CRYPTO_zalloc(
        size_t num,
        const char* file,
        int line);
    OSSL_CRYPTO_ALLOC void* CRYPTO_aligned_alloc(
        size_t num,
        size_t align,
        void** freeptr,
        const char* file,
    ...
    OSSL_CRYPTO_ALLOC void* CRYPTO_secure_malloc(
        size_t num,
        const char* file,
        int line);
    OSSL_CRYPTO_ALLOC void* CRYPTO_secure_zalloc(
        size_t num,
        const char* file,
        int line);
...
#define OPENSSL_mem_debug_pop() CRYPTO_mem_debug_pop()
    ...
    OSSL_DEPRECATEDIN_3_0 int CRYPTO_mem_debug_push(
        const char* info,
        const char* file,
        int line);
    OSSL_DEPRECATEDIN_3_0 int CRYPTO_mem_debug_pop(void);
    OSSL_DEPRECATEDIN_3_0 void CRYPTO_mem_debug_malloc(
        void* addr,
        size_t num,
        int flag,
        const char* file,
        int line);
    OSSL_DEPRECATEDIN_3_0 void CRYPTO_mem_debug_realloc(
        void* addr1,
        void* addr2,
        size_t num,
        int flag,
        const char* file,
        int line);
    OSSL_DEPRECATEDIN_3_0 void CRYPTO_mem_debug_free(
        void* addr,
        int flag,
        const char* file,
        int line);
    ...
    /* die if we have to */
    ossl_noreturn void OPENSSL_die(
...
#define CRYPTO_ONCE_STATIC_INIT 0
    ...
    OSSL_LIB_CTX* OSSL_LIB_CTX_new_from_dispatch(
        const OSSL_CORE_HANDLE* handle,
        const OSSL_DISPATCH* in);
    OSSL_LIB_CTX* OSSL_LIB_CTX_new_child(
        const OSSL_CORE_HANDLE* handle,
        const OSSL_DISPATCH* in);
