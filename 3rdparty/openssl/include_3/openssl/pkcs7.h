/*
 * WARNING: do not edit!
 * Generated by include/openssl/pkcs7.h from include/openssl/pkcs7.h.in
 *
...
extern "C"
{
    ...
    */
    ...
    typedef struct pkcs7_signer_info_st
    {
        ...
        X509_ALGOR*
            digest_enc_alg; /* confusing name, actually used for signing */
...
#define sk_PKCS7_RECIP_INFO_set_cmp_func(sk, cmp) ((sk_PKCS7_RECIP_INFO_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_PKCS7_RECIP_INFO_sk_type(sk), ossl_check_PKCS7_RECIP_INFO_compfunc_type(cmp)))
    ...
    /*
     * The above structure is very very similar to PKCS7_SIGN_ENVELOPE. How
...
#define PKCS7_S_TAIL 2
        ...
        union
        {
            ...
            /* NID_pkcs7_signed */
            PKCS7_SIGNED*
                sign; /* field name 'signed' would clash with C keyword */
            /* NID_pkcs7_enveloped */
