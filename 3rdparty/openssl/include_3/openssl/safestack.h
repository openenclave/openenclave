/*
 * WARNING: do not edit!
 * Generated by include/openssl/safestack.h from include/openssl/safestack.h.in
 *
...
#define SKM_DEFINE_STACK_OF_INTERNAL(t1, t2, t3)                               \
    ...
    static ossl_unused ossl_inline OPENSSL_STACK* ossl_check_##t1##_sk_type(   \
        STACK_OF(t1) * sk)                                                     \
    {                                                                          \
...
#define SKM_DEFINE_STACK_OF(t1, t2, t3)                                        \
    ...
    static ossl_unused ossl_inline t2* sk_##t1##_delete(                       \
        STACK_OF(t1) * sk, int i)                                              \
    {                                                                          \
    ...
    {                                                                          \
        return (t2*)OPENSSL_sk_delete_ptr(                                     \
            (OPENSSL_STACK*)sk, (const void*)ptr);                             \
    }                                                                          \
    static ossl_unused ossl_inline int sk_##t1##_push(                         \
        STACK_OF(t1) * sk, t2 * ptr)                                           \
    {                                                                          \
    ...
    {                                                                          \
        OPENSSL_sk_pop_free(                                                   \
            (OPENSSL_STACK*)sk, (OPENSSL_sk_freefunc)freefunc);                \
    }                                                                          \
    static ossl_unused ossl_inline int sk_##t1##_insert(                       \
        STACK_OF(t1) * sk, t2 * ptr, int idx)                                  \
    {                                                                          \
        return OPENSSL_sk_insert((OPENSSL_STACK*)sk, (const void*)ptr, idx);   \
    }                                                                          \
    static ossl_unused ossl_inline t2* sk_##t1##_set(                          \
        STACK_OF(t1) * sk, int idx, t2* ptr)                                   \
    {                                                                          \
        return (t2*)OPENSSL_sk_set((OPENSSL_STACK*)sk, idx, (const void*)ptr); \
    }                                                                          \
    static ossl_unused ossl_inline int sk_##t1##_find(                         \
        STACK_OF(t1) * sk, t2 * ptr)                                           \
    {                                                                          \
    ...
    static ossl_unused ossl_inline int sk_##t1##_find_all(                     \
        STACK_OF(t1) * sk, t2 * ptr, int* pnum)                                \
    {                                                                          \
        return OPENSSL_sk_find_all(                                            \
            (OPENSSL_STACK*)sk, (const void*)ptr, pnum);                       \
    }                                                                          \
