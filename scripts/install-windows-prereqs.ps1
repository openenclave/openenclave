...
Param(
    ...
    [string]$OpenSSLURL = 'https://oejenkins.blob.core.windows.net/oejenkins/Win64OpenSSL-1_1_1g.exe',
    ...
    [string]$IntelPSWURL = 'https://oejenkins.blob.core.windows.net/oejenkins/Intel%20SGX%20PSW%20for%20Windows%20v2.7.101.2.exe',
    ...
    [string]$IntelDCAPURL = 'https://oejenkins.blob.core.windows.net/oejenkins/Intel%20SGX%20DCAP%20for%20Windows%20v1.6.100.2.exe',
