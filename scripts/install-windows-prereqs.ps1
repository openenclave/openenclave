...
Param(
    ...
    [string]$IntelPSWURL = 'https://registrationcenter-download.intel.com/akdlm/irc_nas/17770/Intel%20SGX%20PSW%20for%20Windows%20v2.12.101.2.exe',
    [string]$IntelPSWHash = 'C3AF09769238F63B2A389D06F88FA5744428B7070256170153F7C757E9594BC9',
    ...
    [string]$IntelDCAPURL = 'https://registrationcenter-download.intel.com/akdlm/irc_nas/17772/Intel%20SGX%20DCAP%20for%20Windows%20v1.10.101.2.exe',
    [string]$IntelDCAPHash = 'F1F928CB937C6D310B64E1EFD4820BFA5AE9D68D79B589454455D6A40C19D27F',
