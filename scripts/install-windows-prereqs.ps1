...
Param(
    ...
    [string]$OpenSSLURL = 'https://slproweb.com/download/Win64OpenSSL-1_1_0L.exe',
    [string]$OpenSSLHash = 'A88A3CB1EDDD3A16C14E0F0D0417144D198741E3BAE5459AE77D311B520B5EFE',
