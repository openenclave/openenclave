...
Param(
    ...
    [string]$AzureDCAPNupkgURL = 'https://www.nuget.org/api/v2/package/Microsoft.Azure.DCAP/1.12.0',
    [string]$AzureDCAPNupkgHash = 'DEFF2146BF64D44AA22004F2C77828958C7356F9FA0360D48DCA168E8389E038',
