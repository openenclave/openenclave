...
Param(
    ...
    [string]$IntelPSWURL = 'https://oejenkins.blob.core.windows.net/oejenkins/Intel%20SGX%20PSW%20for%20Windows%20v2.9.100.2.exe',
    ...
    [string]$IntelDCAPURL = 'https://oejenkins.blob.core.windows.net/oejenkins/Intel%20SGX%20DCAP%20for%20Windows%20v1.8.100.2.exe',
