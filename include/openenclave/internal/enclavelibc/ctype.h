...
#ifndef _OE_ENCLAVELIBC_CTYPE_H
#define _OE_ENCLAVELIBC_CTYPE_H
...
{
    return __oe_ctype_toupper_loc[c];
}

OE_ENCLAVELIBC_INLINE
int oe_tolower(int c)
{
    return __oe_ctype_tolower_loc[c];
}
