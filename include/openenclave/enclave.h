...
*
* Call this function to add a new vector exception handler. If success, the
* registered
...
* @param vectoredHandler The input vector exception handler that must be a
* function
* inside enclave. The same handler can only be registered once, the 2nd
* registration will
* fail.
*
* @returns This function return a opaque handler of new registered handler on
* success,
* caller can use the return value to remove the handler later. Return NULL if
* fail.
*
*/
...
*
* @param vectoredHandler The pointer to a registered exception handler that is a
* return
