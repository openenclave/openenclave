...
OE_CHECK_SIZE(offsetof(SGX_TCS, state), 0);
OE_CHECK_SIZE(offsetof(SGX_TCS, flags), 8);
OE_CHECK_SIZE(offsetof(SGX_TCS, ossa), 16);
OE_CHECK_SIZE(offsetof(SGX_TCS, cssa), 24);
OE_CHECK_SIZE(offsetof(SGX_TCS, nssa), 28);
OE_CHECK_SIZE(offsetof(SGX_TCS, oentry), 32);
OE_CHECK_SIZE(offsetof(SGX_TCS, aep), 40);
OE_CHECK_SIZE(offsetof(SGX_TCS, fsbase), 48);
OE_CHECK_SIZE(offsetof(SGX_TCS, gsbase), 56);
OE_CHECK_SIZE(offsetof(SGX_TCS, fslimit), 64);
OE_CHECK_SIZE(offsetof(SGX_TCS, gslimit), 68);
OE_CHECK_SIZE(offsetof(SGX_TCS, u.reserved), 72);
OE_CHECK_SIZE(offsetof(SGX_TCS, u.main), 72);
